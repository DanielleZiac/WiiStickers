...
class AvatarMaker:
    def __init__(self, root):
        ...
        # Initialize OpenCV video capture for eyes and mouth detection
    ...
    def detect_eyes(self, frame):
        ...
        for face in faces:
            ...
            eyes_status = "closed" if left_eye_distance < 15 and right_eye_distance < 15 else "opened"

            return eyes_status

        return "opened"  # Default if no face is detected
    ...
    def detect_mouth(self, frame):
        ...
        for face in faces:
            ...
            mouth_status = "opened" if shape[66][1] - shape[62][1] > 10 else "closed"
            return mouth_status
    ...
    def update_displayed_image(self):
        ...
        eyes_status = self.detect_eyes(frame)
        mouth_status = self.detect_mouth(frame)

        # Update selected features for eyes and mouth
        self.selected_features["Eyes"] = f"eyes{eyes_status}.png"
        self.selected_features["Mouth"] = f"mouth{mouth_status}.png"
        ...
        cv2.putText(frame, f"Eyes: {eyes_status}", (10, 120),
