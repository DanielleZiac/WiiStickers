...
#quiz_buttons = [
#    {"image_hover": Image.open("gui/buttons/answer.png"), "x": 0.172, "y": 0.512, "width": 0.933, "height": 0.94, "choice": "1"},
#    {"image_hover": Image.open("gui/buttons/answer.png"), "x": 0.172, "y": 0.641, "width": 0.933, "height": 0.94, "choice": "2"},
#    {"image_hover": Image.open("gui/buttons/answer.png"), "x": 0.172, "y": 0.77, "width": 0.933, "height": 0.94, "choice": "3"},
#]
...
class QuizPage:
    ...
    def create_widgets(self):
        ...
        self.x = self.width_value
        self.y = self.height_value

        self.canvas = gui_utils.set_background("gui/pages/quizPage.png")
